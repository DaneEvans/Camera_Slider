/*********************************************************************
 ...
 This works to set up a serial connection - the nRF toolbox > UART works, as does the ardiuino IDE 
I have it intercepting the character ' a ' and toggleing the LED. 
Working pretty easily. 

Can add an app front end, and set up UART control. 
